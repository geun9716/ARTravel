...
export default class App extends Component {
    ...
    return (
      <View style={localStyles.outer}>
        <View style={localStyles.inner}>
          ...
          <TouchableHighlight style={localStyles.buttons} onPress={this._getExperienceButtonOnPress(VR_NAVIGATOR_TYPE)} underlayColor={'#68a0ff'}>
  ...
  _getVRNavigator() {
    return <ViroVRSceneNavigator {...this.state.sharedProps} initialScene={{ scene: InitialVRScene }} onExitViro={this._exitViro} />;
  }
